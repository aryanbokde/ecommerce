...
CREATE TABLE `verifications` (
    ...
    UNIQUE INDEX `verifications_value_key`(`value`),
...
CREATE TABLE `two_factors` (
    ...
    UNIQUE INDEX `two_factors_userId_key`(`userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `support_notes` (
    ...
    INDEX `support_notes_orderId_idx`(`orderId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `support_notes` ADD CONSTRAINT `support_notes_orderId_fkey` FOREIGN KEY (`orderId`) REFERENCES `orders`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
